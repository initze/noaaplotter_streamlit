...
data_file = f'{station_id}.csv'

if st.button('Start Process'):
    # debug
    print('Loading:', data_file)
    print('Station Name:', station_name)
    print('Ref Start Date:', ref_start_date)
    print('Ref End Date:', ref_end_date)
    # download data
    download_from_noaa(data_file, download_start, download_end, ['TMIN', 'TMAX', 'PRCP', 'SNOW'], station_name, station_id, API_TOKEN)
    #print('Successful')
    # plotting
